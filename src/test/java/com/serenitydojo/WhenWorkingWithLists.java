...
public class WhenWorkingWithLists {
    ...
    public void findingTheLengthOfAList() {
        ...
        // TODO: Remote "green" from the list
        // Seems that comment above is from the previous task, I guess the task should be something like
        // Assign actual list size to numberOfElements to check list has correct length
        colors.remove(1);
